export declare const PACKAGE_STRUCTURE: {
    readonly package: "connectingmatrix-logger";
    ...
    readonly movesApplied: {
        readonly backend: readonly [readonly ["logger", "modules/logging"], readonly ["general", "modules/platform"], readonly ["process-monitoring", "modules/monitoring"]];
        readonly ui: readonly [readonly ["app/process-monitoring", "shell/process-monitoring"]];
        readonly entity: readonly [readonly ["repositories/entities", "entities"]];
    };
    readonly counts: {
        readonly ui: {
            readonly files: 26;
            readonly bytes: 102999;
        };
        readonly backend: {
            readonly files: 21;
            readonly bytes: 94424;
        };
        readonly entity: {
            readonly files: 3;
            readonly bytes: 4737;
