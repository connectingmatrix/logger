...
- Path: `packages/apps/logger/src/lib`
...
- Functions (all):
  - `sanitizeValue` (L27-L27, function)
  - `stringifyMeta` (L65-L65, function)
  - `getScopedLogger` (L115-L115, function)
  - `toErrorMeta` (L119-L119, function)
- Exports:
  - `getScopedLogger` (L115)
  - `toErrorMeta` (L119)
- Key snippets and use-case mapping:
  - `L27-L27`: Implements `sanitizeValue` for this module use case.
  - `L65-L65`: Implements `stringifyMeta` for this module use case.
  - `L115-L115`: Implements `getScopedLogger` for this module use case.
  - `L119-L119`: Implements `toErrorMeta` for this module use case.
