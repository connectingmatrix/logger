...
- Functions (all):
  - `nowMs` (L3-L3, arrow)
  - `createLifecycleState` (L5-L5, arrow)
- Exports:
  - `createLifecycleState` (L5)
- Key snippets and use-case mapping:
  - `L3-L3`: Implements `nowMs` for this module use case.
  - `L5-L5`: Implements `createLifecycleState` for this module use case.
