...
export function createConnectingmatrixLoggerStubLauncher(context: RequestContext = {}): PackageLauncherPanel {
  return {
    ...
    actions: [
      { name: 'setup', label: 'setup', method: 'LOCAL' as const, description: 'Run setup demo action' },
      { name: 'info', label: 'info', method: 'LOCAL' as const, description: 'Run info demo action' },
      { name: 'decorator', label: 'decorator', method: 'LOCAL' as const, description: 'Run decorator demo action' }
    ],
...
export const Launcher = { open: createConnectingmatrixLoggerStubLauncher, mode: 'stub' as const };
