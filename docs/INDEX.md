# @connectingmatrix/logger package index

## Ownership

Logger, process monitoring, live logs, process abort/kill/heartbeat and socket log broadcasting.
...
{
  "dependencies": {
    "@connectingmatrix/logger": "file:../packages/logger"
  }
}
```
